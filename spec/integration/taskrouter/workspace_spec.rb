...
describe Twilio::Resources::Taskrouter::WorkspaceList do
  ...
  context "should read workspaces" do
    ...
    it "and return 401" do
      client = Twilio::REST::TaskrouterClient.new('ACllllllllllllllllllllllllllllllll', 'AUTHTOKEN')
      expect { client.workspaces.list(:'FriendlyName' => 'friendly_name') }.to raise_error Twilio::REST::RequestError
    end
  ...
  context "should create workspaces" do
    ...
    it "and return 401" do
      client = Twilio::REST::TaskrouterClient.new('ACllllllllllllllllllllllllllllllll', 'AUTHTOKEN')
      expect { client.workspaces.create(:'EventCallbackUrl' => "/example", :'FriendlyName' => 'friendly_name', :'Template' => 'template') }.to raise_error Twilio::REST::RequestError
    end
...
describe Twilio::Resources::Taskrouter::WorkspaceInstance do
  ...
  context "should update workspaces" do
    it "and return 200" do
      client = Twilio::REST::TaskrouterClient.new('ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'AUTHTOKEN')
      resource = client.workspaces.get('WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa')
      expect { resource.update(:'DefaultActivitySid' => 'default_activity_sid', :'EventCallbackUrl' => "/example", :'FriendlyName' => 'friendly_name', :'TimeoutActivitySid' => 'timeout_activity_sid') }.not_to raise_error
    end
  
    it "and return 401" do
      client = Twilio::REST::TaskrouterClient.new('ACllllllllllllllllllllllllllllllll', 'AUTHTOKEN')
      resource = client.workspaces.get('WSllllllllllllllllllllllllllllllll')
      expect { resource.update(:'DefaultActivitySid' => 'default_activity_sid', :'EventCallbackUrl' => "/example", :'FriendlyName' => 'friendly_name', :'TimeoutActivitySid' => 'timeout_activity_sid') }.to raise_error Twilio::REST::RequestError
    end
