...
describe 'SipDomain' do
  ...
  it "can update" do
    ...
    expect {
      @client.routes.v2.sip_domains('sip_domain').update()
    }.to raise_exception(Twilio::REST::TwilioError)
  ...
  it "receives update responses" do
    ...
    actual = @client.routes.v2.sip_domains('sip_domain').update()
  ...
  it "can fetch" do
    ...
    expect {
      @client.routes.v2.sip_domains('sip_domain').fetch()
    }.to raise_exception(Twilio::REST::TwilioError)
  ...
  it "receives fetch responses" do
    ...
    actual = @client.routes.v2.sip_domains('sip_domain').fetch()
