...
describe Twilio::Resources::V2010::AccountInstance::ApplicationList do
  ...
  context "should create applications" do
    it "and return 200" do
      ...
      expect { client.accounts.get('ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa').applications.create(api_version: 'api_version', friendly_name: 'friendly_name', message_status_callback: "https://example.com", sms_fallback_method: "GET", sms_fallback_url: "https://example.com", sms_method: "GET", sms_status_callback: "https://example.com", sms_url: "https://example.com", status_callback: "https://example.com", status_callback_method: "GET", voice_caller_id_lookup: true, voice_fallback_method: "GET", voice_fallback_url: "https://example.com", voice_method: "GET", voice_url: "https://example.com") }.not_to raise_error
    end
  
    it "and return 401" do
      client = Twilio::REST::Client.new('ACllllllllllllllllllllllllllllllll', 'AUTHTOKEN')
      expect { client.accounts.get('ACllllllllllllllllllllllllllllllll').applications.create(api_version: 'api_version', friendly_name: 'friendly_name', message_status_callback: "https://example.com", sms_fallback_method: "GET", sms_fallback_url: "https://example.com", sms_method: "GET", sms_status_callback: "https://example.com", sms_url: "https://example.com", status_callback: "https://example.com", status_callback_method: "GET", voice_caller_id_lookup: true, voice_fallback_method: "GET", voice_fallback_url: "https://example.com", voice_method: "GET", voice_url: "https://example.com") }.to raise_error Twilio::REST::RequestError
    end
  
    it "and return 404" do
      client = Twilio::REST::Client.new('ACkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk', 'AUTHTOKEN')
      expect { client.accounts.get('ACkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk').applications.create(api_version: 'api_version', friendly_name: 'friendly_name', message_status_callback: "https://example.com", sms_fallback_method: "GET", sms_fallback_url: "https://example.com", sms_method: "GET", sms_status_callback: "https://example.com", sms_url: "https://example.com", status_callback: "https://example.com", status_callback_method: "GET", voice_caller_id_lookup: true, voice_fallback_method: "GET", voice_fallback_url: "https://example.com", voice_method: "GET", voice_url: "https://example.com") }.to raise_error Twilio::REST::RequestError
    end
  
    it "and return 500" do
      client = Twilio::REST::Client.new('ACmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm', 'AUTHTOKEN')
      expect { client.accounts.get('ACmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm').applications.create(api_version: 'api_version', friendly_name: 'friendly_name', message_status_callback: "https://example.com", sms_fallback_method: "GET", sms_fallback_url: "https://example.com", sms_method: "GET", sms_status_callback: "https://example.com", sms_url: "https://example.com", status_callback: "https://example.com", status_callback_method: "GET", voice_caller_id_lookup: true, voice_fallback_method: "GET", voice_fallback_url: "https://example.com", voice_method: "GET", voice_url: "https://example.com") }.to raise_error Twilio::REST::RequestError
    end
  end
...
describe Twilio::Resources::V2010::AccountInstance::ApplicationInstance do
  ...
  context "should update applications" do
    it "and return 200" do
      client = Twilio::REST::Client.new('ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'AUTHTOKEN')
      resource = client.accounts.get('ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa').applications.get('APaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa')
      expect { resource.update(api_version: 'api_version', friendly_name: 'friendly_name', message_status_callback: "https://example.com", sms_fallback_method: "GET", sms_fallback_url: "https://example.com", sms_method: "GET", sms_status_callback: "https://example.com", sms_url: "https://example.com", status_callback: "https://example.com", status_callback_method: "GET", voice_caller_id_lookup: true, voice_fallback_method: "GET", voice_fallback_url: "https://example.com", voice_method: "GET", voice_url: "https://example.com") }.not_to raise_error
    end
