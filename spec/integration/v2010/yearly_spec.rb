...
describe Twilio::Resources::V2010::AccountInstance::UsageList::RecordList::YearlyList do
       ...
       "usage_records": [
        {
         ...
         "usage_unit": "messages"
          ...
          >))
      expect { client.accounts.get('ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa').usage.records.yearly.list() }.not_to raise_error
    end
