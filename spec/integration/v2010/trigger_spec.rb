...
describe Twilio::Resources::V2010::AccountInstance::UsageList::TriggerList do
  ...
  context "should create usage_triggers" do
    it "and return 200" do
      client = Twilio::REST::Client.new('ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'AUTHTOKEN')
      expect { client.accounts.get('ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa').usage.triggers.create(callback_method: "GET", friendly_name: 'friendly_name', usage_category: 'usage_category', trigger_value: 'trigger_value', recurring: 'recurring', trigger_by: 'trigger_by', callback_url: "https://example.com") }.not_to raise_error
    end
  
    it "and return 401" do
      client = Twilio::REST::Client.new('ACllllllllllllllllllllllllllllllll', 'AUTHTOKEN')
      expect { client.accounts.get('ACllllllllllllllllllllllllllllllll').usage.triggers.create(callback_method: "GET", friendly_name: 'friendly_name', usage_category: 'usage_category', trigger_value: 'trigger_value', recurring: 'recurring', trigger_by: 'trigger_by', callback_url: "https://example.com") }.to raise_error Twilio::REST::RequestError
    end
  
    it "and return 404" do
      client = Twilio::REST::Client.new('ACkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk', 'AUTHTOKEN')
      expect { client.accounts.get('ACkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk').usage.triggers.create(callback_method: "GET", friendly_name: 'friendly_name', usage_category: 'usage_category', trigger_value: 'trigger_value', recurring: 'recurring', trigger_by: 'trigger_by', callback_url: "https://example.com") }.to raise_error Twilio::REST::RequestError
    end
  
    it "and return 500" do
      client = Twilio::REST::Client.new('ACmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm', 'AUTHTOKEN')
      expect { client.accounts.get('ACmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm').usage.triggers.create(callback_method: "GET", friendly_name: 'friendly_name', usage_category: 'usage_category', trigger_value: 'trigger_value', recurring: 'recurring', trigger_by: 'trigger_by', callback_url: "https://example.com") }.to raise_error Twilio::REST::RequestError
    end
  end
...
describe Twilio::Resources::V2010::AccountInstance::UsageList::TriggerInstance do
  ...
  context "should update usage_triggers" do
    it "and return 200" do
      client = Twilio::REST::Client.new('ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'AUTHTOKEN')
      resource = client.accounts.get('ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa').usage.triggers.get('UTaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa')
      expect { resource.update(callback_method: "GET", friendly_name: 'friendly_name', callback_url: "https://example.com") }.not_to raise_error
    end
  
    it "and return 401" do
      client = Twilio::REST::Client.new('ACllllllllllllllllllllllllllllllll', 'AUTHTOKEN')
      resource = client.accounts.get('ACllllllllllllllllllllllllllllllll').usage.triggers.get('UTllllllllllllllllllllllllllllllll')
      expect { resource.update(callback_method: "GET", friendly_name: 'friendly_name', callback_url: "https://example.com") }.to raise_error Twilio::REST::RequestError
    end
