    ...
    it "and succeed" do
      ...
      holodeck.mock(Hologram::ANY,
       ...
       "uri": "/2010-04-01/Accounts/ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/IncomingPhoneNumbers/TollFree.json?PageSize=1"
          ...
          >))
      expect { client.accounts.get('ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa').incoming_phone_numbers.toll_free.list(:'Beta' => true, :'FriendlyName' => "friendly_name", :'PhoneNumber' => "+987654321") }.not_to raise_error
    end
