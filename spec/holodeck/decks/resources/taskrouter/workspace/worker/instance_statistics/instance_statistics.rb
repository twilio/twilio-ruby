class TaskrouterHolodeckResource < HolodeckResource
  class StatisticsInstanceHolodeckResource < HolodeckResource
    ...
    @holograms = [
        Hologram.new(
            method: "GET",
            url: "https://taskrouter.twilio.com/v1Workspaces/WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/Workers/WKaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/Statistics.json",
        ...
        Hologram.new(
            method: "DELETE",
            url: "https://taskrouter.twilio.com/v1Workspaces/WSllllllllllllllllllllllllllllllll/Workers/WKllllllllllllllllllllllllllllllll/Statistics.json",
        ...
        Hologram.new(
            method: "DELETE",
            url: "https://taskrouter.twilio.com/v1Workspaces/WSkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk/Workers/WKkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk/Statistics.json",
        ...
        Hologram.new(
            method: "DELETE",
            url: "https://taskrouter.twilio.com/v1Workspaces/WSmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm/Workers/WKmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm/Statistics.json",
