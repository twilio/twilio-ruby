...
require './spec/holodeck/decks/resources/conversations/conversation/in_progress/in_progress/in_progress.rb'

require './spec/holodeck/decks/resources/conversations/conversation/completed/completed/completed.rb'
...
class ConversationInstanceHolodeckResource < HolodeckResource
  ...
  @@handlers = [
      Hologram.new(
          ...
          status_code: 200,
          content_file: File.join(File.dirname(__FILE__), "conversation_200.json"),
          params: '{}',
      ...
      Hologram.new(
          ...
          auth: ["ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "AUTHTOKEN"],
          status_code: 204,
          content_file: File.join(File.dirname(__FILE__), "conversation_204.json"),
          params: '{}',
          headers: HolodeckResource::DEFAULT_HEADERS
      ),
      Hologram.new(
          ...
          status_code: 401,
          content_file: File.join(File.dirname(__FILE__), "conversation_401.json"),
          params: '{}',
          headers: HolodeckResource::DEFAULT_HEADERS
      ),
      Hologram.new(
      ...
      Hologram.new(
          ...
          status_code: 404,
          content_file: File.join(File.dirname(__FILE__), "conversation_404.json"),
          params: '{}',
          headers: HolodeckResource::DEFAULT_HEADERS
      ),
      Hologram.new(
      ...
      Hologram.new(
          ...
          status_code: 500,
          content_file: File.join(File.dirname(__FILE__), "conversation_500.json"),
          params: '{}',
          headers: HolodeckResource::DEFAULT_HEADERS
      ),
      Hologram.new(
