class V2010HolodeckResource < HolodeckResource
  ...
  class IncomingPhoneNumberInstanceHolodeckResource < HolodeckResource
    @sub_resources = {
        local: V2010HolodeckResource::LocalInstanceHolodeckResource,
        mobile: V2010HolodeckResource::MobileInstanceHolodeckResource,
        toll_free: V2010HolodeckResource::TollFreeInstanceHolodeckResource,
    }
    @holograms = [
        Hologram.new(
            method: "GET",
