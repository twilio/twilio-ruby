require './spec/holodeck/decks/resources/v2010/account/sip/credential_list/credential/credential/credential.rb'

class CredentialListInstanceHolodeckResource < HolodeckResource
  @@sub_resources = {
      credentials: CredentialInstanceHolodeckResource,
  }
  @@handlers = [
      Hologram.new(
          method: "GET",
          ...
          status_code: 200,
          content_file: File.join(File.dirname(__FILE__), "sip_credential_list_200.json"),
          params: '{}',
      ...
      Hologram.new(
          ...
          auth: ["ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "AUTHTOKEN"],
          status_code: 204,
          content_file: File.join(File.dirname(__FILE__), "sip_credential_list_204.json"),
          params: '{}',
          headers: HolodeckResource::DEFAULT_HEADERS
      ),
      Hologram.new(
          ...
          status_code: 401,
          content_file: File.join(File.dirname(__FILE__), "sip_credential_list_401.json"),
          params: '{}',
          headers: HolodeckResource::DEFAULT_HEADERS
      ),
      Hologram.new(
      ...
      Hologram.new(
          ...
          status_code: 404,
          content_file: File.join(File.dirname(__FILE__), "sip_credential_list_404.json"),
          params: '{}',
          headers: HolodeckResource::DEFAULT_HEADERS
      ),
      Hologram.new(
      ...
      Hologram.new(
          ...
          status_code: 500,
          content_file: File.join(File.dirname(__FILE__), "sip_credential_list_500.json"),
          params: '{}',
          headers: HolodeckResource::DEFAULT_HEADERS
      ),
      Hologram.new(
