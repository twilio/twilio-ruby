class V2010HolodeckResource < HolodeckResource
  ...
  class DomainInstanceHolodeckResource < HolodeckResource
    @sub_resources = {
        ip_access_control_list_mappings: V2010HolodeckResource::IpAccessControlListMappingInstanceHolodeckResource,
        credential_list_mappings: V2010HolodeckResource::CredentialListMappingInstanceHolodeckResource,
    }
    @holograms = [
        Hologram.new(
            method: "GET",
