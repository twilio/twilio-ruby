class PricingHolodeckResource < HolodeckResource
  ...
  class VoiceInstanceHolodeckResource < HolodeckResource
    @sub_resources = {
        numbers: PricingHolodeckResource::NumberInstanceHolodeckResource,
        countries: PricingHolodeckResource::CountryInstanceHolodeckResource,
    }
    @holograms = [
        Hologram.new(
            method: "GET",
            url: "https://pricing.twilio.com/v1/Voice.json",
