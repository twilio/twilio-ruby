            ...
            class V2 < Version
                class BulkHostedNumberOrderList < ListResource
                    ...
                    def create_with_metadata(body: :unset
                        ...
                        bulkHostedNumberOrder_instance = BulkHostedNumberOrderInstance.new(
                            @version,
                            response.body,
                        )
                        BulkHostedNumberOrderInstanceMetadata.new(
                            @version,
                            bulkHostedNumberOrder_instance,
                            response.headers,
                ...
                class BulkHostedNumberOrderPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @bulk_hosted_number_order_page << BulkHostedNumberOrderListResponse.new(version, @payload, key)
                ...
                class BulkHostedNumberOrderListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @bulk_hosted_number_order = payload.body[key].map do |data|
                      BulkHostedNumberOrderInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
