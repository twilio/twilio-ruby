        ...
        class Numbers < NumbersBase
            class V2 < Version
                ...
                class SupportingDocumentPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @supporting_document_page << SupportingDocumentListResponse.new(version, @payload, key)
                ...
                class SupportingDocumentListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @supporting_document = payload.body[key].map do |data|
                      SupportingDocumentInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
