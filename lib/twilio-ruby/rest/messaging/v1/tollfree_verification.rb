                ...
                class TollfreeVerificationList < ListResource
                    ...
                    def create(
                        ...
                        data = Twilio::Values.of({
                            ...
                            'UseCaseCategories' => use_case_categories.is_a?(Array) ? use_case_categories.join(',') : use_case_categories,
                            'UseCaseSummary' => use_case_summary,
                            'ProductionMessageSample' => production_message_sample,
                            'OptInImageUrls' => opt_in_image_urls.is_a?(Array) ? opt_in_image_urls.join(',') : opt_in_image_urls,
