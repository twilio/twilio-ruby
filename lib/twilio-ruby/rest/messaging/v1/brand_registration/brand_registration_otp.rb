            ...
            class V1 < Version
                class BrandRegistrationContext < InstanceContext
                    ...
                    def create_with_metadata
                        ...
                        brandRegistrationOtp_instance = BrandRegistrationOtpInstance.new(
                            @version,
                            response.body,
                            brand_registration_sid: @solution[:brand_registration_sid],
                        )
                ...
                class BrandRegistrationOtpPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @brand_registration_otp_page << BrandRegistrationOtpListResponse.new(version, @payload, key)
                ...
                class BrandRegistrationOtpListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key)
                      @brand_registration_otp = payload.body[key].map do |data|
