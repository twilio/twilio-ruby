        ...
        class FlexApi < FlexApiBase
            class V1 < Version
                class PluginContext < InstanceContext
                    ...
                    def create_with_metadata(
                      ...
                      flex_metadata: :unset
                        ...
                        pluginVersions_instance = PluginVersionsInstance.new(
                            @version,
                            response.body,
                            plugin_sid: @solution[:plugin_sid],
                        )
                ...
                class PluginVersionsPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @plugin_versions_page << PluginVersionsListResponse.new(version, @payload, key)
                ...
                class PluginVersionsListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @plugin_versions = payload.body[key].map do |data|
                      PluginVersionsInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
