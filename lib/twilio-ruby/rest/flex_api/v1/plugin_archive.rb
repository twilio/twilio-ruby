        ...
        class FlexApi < FlexApiBase
            class V1 < Version
                ...
                class PluginArchiveContext < InstanceContext
                    ...
                    def update_with_metadata(
                      flex_metadata: :unset
                        ...
                        pluginArchive_instance = PluginArchiveInstance.new(
                            @version,
                            response.body,
                            sid: @solution[:sid],
                        )
                ...
                class PluginArchivePageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @plugin_archive_page << PluginArchiveListResponse.new(version, @payload, key)
                ...
                class PluginArchiveListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @plugin_archive = payload.body[key].map do |data|
                      PluginArchiveInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
