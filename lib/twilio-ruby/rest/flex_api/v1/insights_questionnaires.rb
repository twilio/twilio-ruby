        ...
        class FlexApi < FlexApiBase
            class V1 < Version
                    ...
                    def create_with_metadata(
                      ...
                      authorization: :unset
                        ...
                        InsightsQuestionnairesInstanceMetadata.new(
                            @version,
                            insightsQuestionnaires_instance,
                            response.headers,
                ...
                class InsightsQuestionnairesPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @insights_questionnaires_page << InsightsQuestionnairesListResponse.new(version, @payload, key)
                ...
                class InsightsQuestionnairesListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @insights_questionnaires = payload.body[key].map do |data|
                      InsightsQuestionnairesInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
