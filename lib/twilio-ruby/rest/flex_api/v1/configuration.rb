        ...
        class ConfigurationInstance < InstanceResource
          ...
          def initialize(version, payload)
            ...
            @properties = {
                ...
                'ui_language' => payload['ui_language'].to_json,
                'ui_attributes' => payload['ui_attributes'],
                'ui_version' => payload['ui_version'].to_json,
                'service_version' => payload['service_version'].to_json,
                ...
                'crm_type' => payload['crm_type'].to_json,
