            ...
            class V1 < Version
                ...
                class DeliveryReceiptContext < InstanceContext
                    ...
                    def fetch_with_metadata
                        ...
                        deliveryReceipt_instance = DeliveryReceiptInstance.new(
                            @version,
                            response.body,
                            chat_service_sid: @solution[:chat_service_sid],
                            conversation_sid: @solution[:conversation_sid],
                ...
                class DeliveryReceiptPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @delivery_receipt_page << DeliveryReceiptListResponse.new(version, @payload, key)
                ...
                class DeliveryReceiptListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @delivery_receipt = payload.body[key].map do |data|
                      DeliveryReceiptInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
