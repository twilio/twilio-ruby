          ...
          class CallInstance < InstanceResource
            ...
            def initialize(version, payload, account_sid: nil, sid: nil)
              ...
              @properties = {
                  ...
                  'annotation' => payload['annotation'].to_json,
                  'answered_by' => payload['answered_by'].to_json,
                  'api_version' => payload['api_version'].to_json,
                  'caller_name' => payload['caller_name'].to_json,
                  'date_created' => Twilio.deserialize_rfc2822(payload['date_created']),
                  'date_updated' => Twilio.deserialize_rfc2822(payload['date_updated']),
                  'direction' => payload['direction'].to_json,
                  'duration' => payload['duration'].to_json,
                  'end_time' => Twilio.deserialize_rfc2822(payload['end_time']),
                  'forwarded_from' => payload['forwarded_from'].to_json,
                  'from' => payload['from'].to_json,
                  'from_formatted' => payload['from_formatted'].to_json,
                  ...
                  'to_formatted' => payload['to_formatted'].to_json,
                  'uri' => payload['uri'],
              }
