        ...
        class Api < ApiBase
            class V2010 < Version
                ...
                class RecordList < ListResource
                    ...
                    # @param [UsageRecordTodayCategory] category The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
                ...
                class TodayInstance < InstanceResource
                    ...
                    ##
                    # @return [UsageRecordTodayCategory] 
                    def category
                        @properties['category']
                    end
