        ...
        class Api < ApiBase
            class V2010 < Version
                    ...
                    def create_with_metadata(
                      credential_list_sid: nil
                        ...
                        AuthRegistrationsCredentialListMappingInstanceMetadata.new(
                            @version,
                            authRegistrationsCredentialListMapping_instance,
                            response.headers,
                ...
                class AuthRegistrationsCredentialListMappingPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @auth_registrations_credential_list_mapping_page << AuthRegistrationsCredentialListMappingListResponse.new(version, @payload, key)
                ...
                class AuthRegistrationsCredentialListMappingListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @auth_registrations_credential_list_mapping = payload.body[key].map do |data|
                      AuthRegistrationsCredentialListMappingInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
