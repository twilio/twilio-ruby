        ...
        class Api < ApiBase
            class V2010 < Version
                    ...
                    def create_with_metadata(
                      credential_list_sid: nil
                        ...
                        AuthCallsCredentialListMappingInstanceMetadata.new(
                            @version,
                            authCallsCredentialListMapping_instance,
                            response.headers,
                ...
                class AuthCallsCredentialListMappingPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @auth_calls_credential_list_mapping_page << AuthCallsCredentialListMappingListResponse.new(version, @payload, key)
                ...
                class AuthCallsCredentialListMappingListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @auth_calls_credential_list_mapping = payload.body[key].map do |data|
                      AuthCallsCredentialListMappingInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
