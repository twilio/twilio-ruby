            ...
            class TollFreeInstance < InstanceResource
              ...
              def initialize(version, payload, account_sid: nil, country_code: nil)
                ...
                @properties = {
                    ...
                    'lata' => payload['lata'].to_json,
                    'locality' => payload['locality'].to_json,
                    'rate_center' => payload['rate_center'].to_json,
                    'latitude' => payload['latitude'].to_f,
                    'longitude' => payload['longitude'].to_f,
                    'region' => payload['region'].to_json,
                    'postal_code' => payload['postal_code'].to_json,
                    'iso_country' => payload['iso_country'],
                    'address_requirements' => payload['address_requirements'].to_json,
                    'beta' => payload['beta'],
