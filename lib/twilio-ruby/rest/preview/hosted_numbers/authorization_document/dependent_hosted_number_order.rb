          ...
          class DependentHostedNumberOrderInstance < InstanceResource
            ...
            def initialize(version, payload, signing_document_sid: nil)
              ...
              @properties = {
                  ...
                  'failure_reason' => payload['failure_reason'].to_json,
                  'date_created' => Twilio.deserialize_iso8601_datetime(payload['date_created']),
                  'date_updated' => Twilio.deserialize_iso8601_datetime(payload['date_updated']),
                  'verification_attempts' => payload['verification_attempts'].to_i,
                  'email' => payload['email'].to_json,
                  'cc_emails' => payload['cc_emails'].to_json,
                  'verification_type' => payload['verification_type'],
                  'verification_document_sid' => payload['verification_document_sid'],
                  'extension' => payload['extension'].to_json,
                  'call_delay' => payload['call_delay'].to_i,
                  'verification_code' => payload['verification_code'].to_json,
                  'verification_call_sids' => payload['verification_call_sids'].to_json,
              }
            end
