    ...
    class Preview < Domain
      class Wireless < Version
        class RatePlanList < ListResource
          ...
          def create(unique_name: Twilio::Values::Unset, friendly_name: Twilio::Values::Unset, data_enabled: Twilio::Values::Unset, data_limit: Twilio::Values::Unset, data_metering: Twilio::Values::Unset, messaging_enabled: Twilio::Values::Unset, voice_enabled: Twilio::Values::Unset, commands_enabled: Twilio::Values::Unset, national_roaming_enabled: Twilio::Values::Unset, international_roaming: Twilio::Values::Unset)
