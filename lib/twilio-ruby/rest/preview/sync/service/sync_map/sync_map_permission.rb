        ...
        class Preview < PreviewBase
            class Sync < Version
                ...
                class SyncMapPermissionContext < InstanceContext
                    ...
                    # @param [String] map_sid Identifier of the Sync Map. Either a SID or a unique name.
                ...
                class SyncMapPermissionInstance < InstanceResource
                    ...
                    ##
                    # @return [String] The unique SID identifier of the Sync Map to which the Permission applies.
                    def map_sid
                        @properties['map_sid']
                    end
                    ...
                    ##
                    # @return [Boolean] Boolean flag specifying whether the identity can read the Sync Map and its Items.
                    def read
                        @properties['read']
                    end
                    
                    ##
                    # @return [Boolean] Boolean flag specifying whether the identity can create, update and delete Items of the Sync Map.
                    def write
                        @properties['write']
                    end
                    
                    ##
                    # @return [Boolean] Boolean flag specifying whether the identity can delete the Sync Map.
                    def manage
                        @properties['manage']
                    end
                    
                    ##
                    # @return [String] Contains an absolute URL for this Sync Map Permission.
                    def url
                        @properties['url']
                    end
