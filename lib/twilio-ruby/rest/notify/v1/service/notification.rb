          ...
          class NotificationInstance < InstanceResource
            ...
            def initialize(version, payload, service_sid: nil)
              ...
              @properties = {
                  ...
                  'identities' => payload['identities'].to_json,
                  'tags' => payload['tags'].to_json,
                  'segments' => payload['segments'].to_json,
                  'priority' => payload['priority'],
                  'ttl' => payload['ttl'].to_i,
                  'title' => payload['title'].to_json,
                  'body' => payload['body'].to_json,
                  'sound' => payload['sound'].to_json,
                  'action' => payload['action'].to_json,
                  'data' => payload['data'],
                  'apn' => payload['apn'],
                  'gcm' => payload['gcm'],
                  'fcm' => payload['fcm'],
