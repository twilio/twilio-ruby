        ...
        class ServiceInstance < InstanceResource
          ...
          def initialize(version, payload, sid: nil)
            ...
            @properties = {
                ...
                'facebook_messenger_page_id' => payload['facebook_messenger_page_id'].to_json,
                'default_apn_notification_protocol_version' => payload['default_apn_notification_protocol_version'].to_json,
                'default_gcm_notification_protocol_version' => payload['default_gcm_notification_protocol_version'].to_json,
                'default_fcm_notification_protocol_version' => payload['default_fcm_notification_protocol_version'].to_json,
                'log_enabled' => payload['log_enabled'],
                'url' => payload['url'],
                'links' => payload['links'],
                'alexa_skill_id' => payload['alexa_skill_id'].to_json,
                'default_alexa_notification_protocol_version' => payload['default_alexa_notification_protocol_version'].to_json,
            }
