...
module Twilio
  module REST
    ...
    class Client
      ...
      attr_accessor :http_client, :username, :password, :account_sid, :auth_token, :region, :edge, :log_level

      ##
      # Initializes the Twilio Client
      def initialize(username=nil, password=nil, account_sid=nil, region=nil, http_client=nil, log_level=nil)
        ...
        @log_level = log_level || ENV['TWILIO_LOG_LEVEL'] || Twilio.log_level
      ...
      def request(host, port, method, uri, params={}, data={}, headers={}, auth=nil, timeout=nil)
        ...
        if @log_level and @log_level.downcase == "debug"
          log = Logger.new(STDOUT)
          log.debug("--BEGIN Twilio API Request--")
          ...
          log.debug("Response Status Code:#{response.status_code}")
          log.debug("Response Headers:#{response.headers}")
          log.debug("--END TWILIO API REQUEST--")
        end
