        ...
        class Autopilot < AutopilotBase
            class V1 < Version
                ...
                class FieldTypeContext < InstanceContext
                    ...
                    # @param [Version] version Version that contains the resource
                    # @param [String] assistant_sid The SID of the [Assistant](https://www.twilio.com/docs/autopilot/api/assistant) that is the parent of the to update.
                ...
                class FieldTypeInstance < InstanceResource
                    ...
                    ##
                    # @return [String] The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the FieldType resource.
                    def account_sid
                    ...
                    ##
                    # @return [String] The unique string that we created to identify the FieldType resource.
                    def sid
                        @properties['sid']
                    end
