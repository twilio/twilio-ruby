            ...
            class V2 < Version
                ...
                class FlowRevisionContext < InstanceContext
                    ...
                    def fetch_with_metadata
                        ...
                        flowRevision_instance = FlowRevisionInstance.new(
                            @version,
                            response.body,
                            sid: @solution[:sid],
                            revision: @solution[:revision],
                ...
                class FlowRevisionPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @flow_revision_page << FlowRevisionListResponse.new(version, @payload, key)
                ...
                class FlowRevisionListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @flow_revision = payload.body[key].map do |data|
                      FlowRevisionInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
