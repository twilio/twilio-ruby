            ...
            class V1 < Version
                ...
                class StepContextContext < InstanceContext
                    ...
                    def fetch_with_metadata
                        ...
                        stepContext_instance = StepContextInstance.new(
                            @version,
                            response.body,
                            flow_sid: @solution[:flow_sid],
                            engagement_sid: @solution[:engagement_sid],
                ...
                class StepContextPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @step_context_page << StepContextListResponse.new(version, @payload, key)
                ...
                class StepContextListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @step_context = payload.body[key].map do |data|
                      StepContextInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
