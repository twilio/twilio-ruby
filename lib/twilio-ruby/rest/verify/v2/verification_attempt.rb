            ...
            class V2 < Version
                ...
                class VerificationAttemptContext < InstanceContext
                    ...
                    def fetch_with_metadata
                        ...
                        verificationAttempt_instance = VerificationAttemptInstance.new(
                            @version,
                            response.body,
                            sid: @solution[:sid],
                        )
                ...
                class VerificationAttemptPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @verification_attempt_page << VerificationAttemptListResponse.new(version, @payload, key)
                ...
                class VerificationAttemptListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @verification_attempt = payload.body[key].map do |data|
                      VerificationAttemptInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
