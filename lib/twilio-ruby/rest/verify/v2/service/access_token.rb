        ...
        class Verify < VerifyBase
            class V2 < Version
                class ServiceContext < InstanceContext
                    ...
                    def create_with_metadata(
                      ...
                      ttl: :unset
                        ...
                        accessToken_instance = AccessTokenInstance.new(
                            @version,
                            response.body,
                            service_sid: @solution[:service_sid],
                        )
                ...
                class AccessTokenPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @access_token_page << AccessTokenListResponse.new(version, @payload, key)
                ...
                class AccessTokenListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @access_token = payload.body[key].map do |data|
                      AccessTokenInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
