        ...
        class Chat < ChatBase
            class V2 < Version
                class ServiceContext < InstanceContext
                    ...
                    # @param [Array[BindingBindingType]] binding_type The push technology used by the Binding resources to read.  Can be: `apn`, `gcm`, or `fcm`.  See [push notification configuration](https://www.twilio.com/docs/chat/push-notification-configuration) for more info.
