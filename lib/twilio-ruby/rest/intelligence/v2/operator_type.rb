            ...
            class V2 < Version
                ...
                class OperatorTypeContext < InstanceContext
                    ...
                    def fetch_with_metadata
                        ...
                        operatorType_instance = OperatorTypeInstance.new(
                            @version,
                            response.body,
                            sid: @solution[:sid],
                        )
                ...
                class OperatorTypePageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @operator_type_page << OperatorTypeListResponse.new(version, @payload, key)
                ...
                class OperatorTypeListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @operator_type = payload.body[key].map do |data|
                      OperatorTypeInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
