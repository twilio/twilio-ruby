        ...
        class Intelligence < IntelligenceBase
            class V2 < Version
                ...
                class OperatorAttachmentPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @operator_attachment_page << OperatorAttachmentListResponse.new(version, @payload, key)
                ...
                class OperatorAttachmentListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @operator_attachment = payload.body[key].map do |data|
                      OperatorAttachmentInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
