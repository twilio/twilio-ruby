        ...
        class Intelligence < IntelligenceBase
            class V2 < Version
                ...
                class EncryptedSentencesContext < InstanceContext
                    ...
                    def fetch_with_metadata(
                      redacted: :unset
                        ...
                        encryptedSentences_instance = EncryptedSentencesInstance.new(
                            @version,
                            response.body,
                            transcript_sid: @solution[:transcript_sid],
                        )
                ...
                class EncryptedSentencesPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @encrypted_sentences_page << EncryptedSentencesListResponse.new(version, @payload, key)
                ...
                class EncryptedSentencesListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @encrypted_sentences = payload.body[key].map do |data|
                      EncryptedSentencesInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
