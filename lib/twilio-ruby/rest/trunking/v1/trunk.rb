    ...
    class Trunking < Domain
      class V1 < Version
        class TrunkList < ListResource
          ...
          def create(friendly_name: Twilio::Values::Unset, domain_name: Twilio::Values::Unset, disaster_recovery_url: Twilio::Values::Unset, disaster_recovery_method: Twilio::Values::Unset, recording: Twilio::Values::Unset, secure: Twilio::Values::Unset)
        ...
        class TrunkContext < InstanceContext
          ...
          def update(friendly_name: Twilio::Values::Unset, domain_name: Twilio::Values::Unset, disaster_recovery_url: Twilio::Values::Unset, disaster_recovery_method: Twilio::Values::Unset, recording: Twilio::Values::Unset, secure: Twilio::Values::Unset)
            data = Twilio::Values.of({
                'FriendlyName' => friendly_name,
                'DomainName' => domain_name,
                'DisasterRecoveryUrl' => disaster_recovery_url,
