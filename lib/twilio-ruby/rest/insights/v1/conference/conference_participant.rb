        ...
        class Insights < InsightsBase
            class V1 < Version
                ...
                class ConferenceParticipantContext < InstanceContext
                    ...
                    def fetch_with_metadata(
                      ...
                      metrics: :unset
                        ...
                        conferenceParticipant_instance = ConferenceParticipantInstance.new(
                            @version,
                            response.body,
                            conference_sid: @solution[:conference_sid],
                            participant_sid: @solution[:participant_sid],
                        ...
                        ConferenceParticipantInstanceMetadata.new(
                            @version,
                            conferenceParticipant_instance,
                            response.headers,
                ...
                class ConferenceParticipantPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @conference_participant_page << ConferenceParticipantListResponse.new(version, @payload, key)
                ...
                class ConferenceParticipantListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @conference_participant = payload.body[key].map do |data|
                      ConferenceParticipantInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
