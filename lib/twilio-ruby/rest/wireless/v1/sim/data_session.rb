          ...
          class DataSessionInstance < InstanceResource
            ...
            def initialize(version, payload, sim_sid: nil)
              ...
              @properties = {
                  ...
                  'radio_link' => payload['radio_link'].to_json,
                  'operator_mcc' => payload['operator_mcc'].to_json,
                  'operator_mnc' => payload['operator_mnc'].to_json,
                  'operator_country' => payload['operator_country'].to_json,
                  'operator_name' => payload['operator_name'].to_json,
                  'cell_id' => payload['cell_id'].to_json,
