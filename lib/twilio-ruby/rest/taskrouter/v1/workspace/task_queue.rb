          ...
          class TaskQueueInstance < InstanceResource
            ...
            def initialize(version, payload, workspace_sid: nil, sid: nil)
              ...
              @properties = {
                  ...
                  'assignment_activity_name' => payload['assignment_activity_name'].to_json,
                  ...
                  'reservation_activity_name' => payload['reservation_activity_name'].to_json,
                  'sid' => payload['sid'],
                  'target_workers' => payload['target_workers'].to_json,
