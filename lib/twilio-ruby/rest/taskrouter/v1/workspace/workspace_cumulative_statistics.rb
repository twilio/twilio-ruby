        ...
        class Taskrouter < TaskrouterBase
            class V1 < Version
                ...
                class WorkspaceCumulativeStatisticsContext < InstanceContext
                    ...
                    def fetch_with_metadata(
                      ...
                      split_by_wait_time: :unset
                        ...
                        workspaceCumulativeStatistics_instance = WorkspaceCumulativeStatisticsInstance.new(
                            @version,
                            response.body,
                            workspace_sid: @solution[:workspace_sid],
                        )
                        WorkspaceCumulativeStatisticsInstanceMetadata.new(
                            @version,
                            workspaceCumulativeStatistics_instance,
                            response.headers,
                ...
                class WorkspaceCumulativeStatisticsPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @workspace_cumulative_statistics_page << WorkspaceCumulativeStatisticsListResponse.new(version, @payload, key)
                ...
                class WorkspaceCumulativeStatisticsListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @workspace_cumulative_statistics = payload.body[key].map do |data|
                      WorkspaceCumulativeStatisticsInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
