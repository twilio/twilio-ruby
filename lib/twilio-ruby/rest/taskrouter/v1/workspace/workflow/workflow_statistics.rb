        ...
        class Taskrouter < TaskrouterBase
            class V1 < Version
                ...
                class WorkflowStatisticsContext < InstanceContext
                    ...
                    def fetch_with_metadata(
                      ...
                      split_by_wait_time: :unset
                        ...
                        workflowStatistics_instance = WorkflowStatisticsInstance.new(
                            @version,
                            response.body,
                            workspace_sid: @solution[:workspace_sid],
                            workflow_sid: @solution[:workflow_sid],
                ...
                class WorkflowStatisticsPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @workflow_statistics_page << WorkflowStatisticsListResponse.new(version, @payload, key)
                ...
                class WorkflowStatisticsListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @workflow_statistics = payload.body[key].map do |data|
                      WorkflowStatisticsInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
