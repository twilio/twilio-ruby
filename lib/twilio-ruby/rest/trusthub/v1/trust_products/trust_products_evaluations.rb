        ...
        class Trusthub < TrusthubBase
            class V1 < Version
                class TrustProductsContext < InstanceContext
                    ...
                    def create_with_metadata(
                      policy_sid: nil
                        ...
                        trustProductsEvaluations_instance = TrustProductsEvaluationsInstance.new(
                            @version,
                            response.body,
                            trust_product_sid: @solution[:trust_product_sid],
                        )
                        TrustProductsEvaluationsInstanceMetadata.new(
                            @version,
                            trustProductsEvaluations_instance,
                            response.headers,
                ...
                class TrustProductsEvaluationsPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && number_of_records <= limit )
                            @trust_products_evaluations_page << TrustProductsEvaluationsListResponse.new(version, @payload, key)
                ...
                class TrustProductsEvaluationsListResponse < InstanceListResource
                    ...
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                      @trust_products_evaluations = payload.body[key].map do |data|
                      TrustProductsEvaluationsInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code
