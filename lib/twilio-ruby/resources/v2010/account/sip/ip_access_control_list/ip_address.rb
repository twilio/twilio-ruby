          ...
          class IpAccessControlListInstance < Twilio::REST::InstanceResource
            class IpAddressList < Twilio::REST::ListResource
              ...
              def initialize(client, inheritance={})
                super
                path "/Accounts/#{@account_sid}/SIP/IpAccessControlLists/#{@ip_access_control_list_sid}/IpAddresses.json"
                instance_id_key 'sid'
            ...
            class IpAddressInstance < Twilio::REST::InstanceResource
              ...
              def initialize(client, inheritance={}, params={}, query_params={})
                super
                path "/Accounts/#{@account_sid}/SIP/IpAccessControlLists/#{@ip_access_control_list_sid}/IpAddresses/#{@sid}.json"
                instance_id_key 'sid'
              end
            end
          end
